...
public class FoodContent extends Fragment {

    private static final String TAG = "FoodContent";
    private RecyclerView mFoodList;
    private DatabaseReference mFirebaseRef;
    private LinearLayoutManager manager;
    private FirebaseRecyclerAdapter<Menu, FoodContent.ViewHolder> firebaseRecyclerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.activity_food_content, container,false);
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Menu, FoodContent.ViewHolder>(Menu.class, R.layout.food_card, FoodContent.ViewHolder.class, FoodQuery) {
            @Override
            protected void populateViewHolder(FoodContent.ViewHolder viewHolder, Menu model, int position) {
